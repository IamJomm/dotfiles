		...
		config = function()
			require("rose-pine").setup({
				palette = {
					main = {
						_nc = "#1e1e1e", --"#16141f"
						base = "#070707", --"#191724" custom
						surface = "#2d2d2d", --#1f1d2e"
						overlay = "#3a3a3a", --"#26233a"
						muted = "#878787", --"#6e6a86",
						subtle = "#aaaaaa", --"#908caa",
						text = "#f4f4f4", --"#e0def4",
						love = "#eaeaea", --"#eb6f92",
						gold = "#f4f4f4", --,"#f6c177",
						rose = "#eaeaea", --"#ebbcba",
						...
						iris = "#e8e8e8", --"#c4a7e7",
						leaf = "#afafaf", --"#95b1ac",
						highlight_low = "#2d2d2d", --"#21202e",
						highlight_med = "#515151", --"#403d52",
						highlight_high = "#666666", --"#524f67",
						none = "NONE",
					},
				},
			})
